...
export class RedPlayer extends GameEntity {
    ...
    constructor() {
        ...
        frontSprite.addSprite(spriteSheet.getSprite("redPlayer","front1"));
        frontSprite.addSprite(spriteSheet.getSprite("redPlayer","front2"));
        frontSprite.addSprite(spriteSheet.getSprite("redPlayer","front3"));
        ...
        backSprite.addSprite(spriteSheet.getSprite("redPlayer","back1"));
        backSprite.addSprite(spriteSheet.getSprite("redPlayer","back2"));
        backSprite.addSprite(spriteSheet.getSprite("redPlayer","back3"));
        ...
        leftSprite.addSprite(spriteSheet.getSprite("redPlayer","left1"));
        leftSprite.addSprite(spriteSheet.getSprite("redPlayer","left2"));
        leftSprite.addSprite(spriteSheet.getSprite("redPlayer","left3"));
        ...
        rightSprite.addSprite(spriteSheet.getSprite("redPlayer","right1"));
        rightSprite.addSprite(spriteSheet.getSprite("redPlayer","right2"));
        rightSprite.addSprite(spriteSheet.getSprite("redPlayer","right3"));
        ...
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death1"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death2"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death3"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death4"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death5"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death6"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death7"));
        deadSprite.addSprite(spriteSheet.getSprite("redPlayer","death8"));
