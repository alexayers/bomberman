...
export class OrangePlayer extends GameEntity {
    ...
    constructor() {
        ...
        frontSprite.addSprite(spriteSheet.getSprite("orangePlayer","front1"));
        frontSprite.addSprite(spriteSheet.getSprite("orangePlayer","front2"));
        frontSprite.addSprite(spriteSheet.getSprite("orangePlayer","front3"));
        ...
        backSprite.addSprite(spriteSheet.getSprite("orangePlayer","back1"));
        backSprite.addSprite(spriteSheet.getSprite("orangePlayer","back2"));
        backSprite.addSprite(spriteSheet.getSprite("orangePlayer","back3"));
        ...
        leftSprite.addSprite(spriteSheet.getSprite("orangePlayer","left1"));
        leftSprite.addSprite(spriteSheet.getSprite("orangePlayer","left2"));
        leftSprite.addSprite(spriteSheet.getSprite("orangePlayer","left3"));
        ...
        rightSprite.addSprite(spriteSheet.getSprite("orangePlayer","right1"));
        rightSprite.addSprite(spriteSheet.getSprite("orangePlayer","right2"));
        rightSprite.addSprite(spriteSheet.getSprite("orangePlayer","right3"));
        ...
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death1"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death2"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death3"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death4"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death5"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death6"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death7"));
        deadSprite.addSprite(spriteSheet.getSprite("orangePlayer","death8"));
