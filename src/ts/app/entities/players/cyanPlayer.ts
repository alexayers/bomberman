...
export class CyanPlayer extends GameEntity {
    ...
    constructor() {
        ...
        frontSprite.addSprite(spriteSheet.getSprite("cyanPlayer","front1"));
        frontSprite.addSprite(spriteSheet.getSprite("cyanPlayer","front2"));
        frontSprite.addSprite(spriteSheet.getSprite("cyanPlayer","front3"));
        ...
        backSprite.addSprite(spriteSheet.getSprite("cyanPlayer","back1"));
        backSprite.addSprite(spriteSheet.getSprite("cyanPlayer","back2"));
        backSprite.addSprite(spriteSheet.getSprite("cyanPlayer","back3"));
        ...
        leftSprite.addSprite(spriteSheet.getSprite("cyanPlayer","left1"));
        leftSprite.addSprite(spriteSheet.getSprite("cyanPlayer","left2"));
        leftSprite.addSprite(spriteSheet.getSprite("cyanPlayer","left3"));
        ...
        rightSprite.addSprite(spriteSheet.getSprite("cyanPlayer","right1"));
        rightSprite.addSprite(spriteSheet.getSprite("cyanPlayer","right2"));
        rightSprite.addSprite(spriteSheet.getSprite("cyanPlayer","right3"));
        ...
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death1"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death2"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death3"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death4"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death5"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death6"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death7"));
        deadSprite.addSprite(spriteSheet.getSprite("cyanPlayer","death8"));
