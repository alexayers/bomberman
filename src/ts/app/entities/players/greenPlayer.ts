...
export class GreenPlayer extends GameEntity {
    ...
    constructor() {
        ...
        frontSprite.addSprite(spriteSheet.getSprite("greenPlayer","front1"));
        frontSprite.addSprite(spriteSheet.getSprite("greenPlayer","front2"));
        frontSprite.addSprite(spriteSheet.getSprite("greenPlayer","front3"));
        ...
        backSprite.addSprite(spriteSheet.getSprite("greenPlayer","back1"));
        backSprite.addSprite(spriteSheet.getSprite("greenPlayer","back2"));
        backSprite.addSprite(spriteSheet.getSprite("greenPlayer","back3"));
        ...
        leftSprite.addSprite(spriteSheet.getSprite("greenPlayer","left1"));
        leftSprite.addSprite(spriteSheet.getSprite("greenPlayer","left2"));
        leftSprite.addSprite(spriteSheet.getSprite("greenPlayer","left3"));
        ...
        rightSprite.addSprite(spriteSheet.getSprite("greenPlayer","right1"));
        rightSprite.addSprite(spriteSheet.getSprite("greenPlayer","right2"));
        rightSprite.addSprite(spriteSheet.getSprite("greenPlayer","right3"));
        ...
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death1"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death2"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death3"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death4"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death5"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death6"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death7"));
        deadSprite.addSprite(spriteSheet.getSprite("greenPlayer","death8"));
